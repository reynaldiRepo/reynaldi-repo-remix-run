...
import type { ExperienceData } from "~/const/experience";
import { ExperiencesList } from "~/const/experience";
  ...
  return (
    <AccordionItem>
      <Box>
        ...
        >
          <Flex
            ...
            gap={"3"}
          >
            <Image src={props.data.icon} w={"50px"} />
            <Box w={"full"} textAlign={"left"}>
              ...
              <Box lineHeight={"1.2"}>
                ...
                >
                  ...
                  <Text whiteSpace={"nowrap"}>{props.data.location}</Text>
                </Box>
      ...
      <AccordionPanel pb={8} px={0}>
        ...
        <List mb={"4"}>
          {props.data.jobDesc.map((job, idx) => {
            return (
              <ListItem
                key={idx}
                fontSize={"sm"}
      ...
      <Container maxW={"5xl"} py={"20"}>
        ...
        <Accordion allowMultiple defaultIndex={[0]}>
          {ExperiencesList.map((exp, idx) => {
            return <ExperienceItem data={exp} key={idx} />;
          })}
        </Accordion>
      </Container>
    </Box>
