        ...
        >
            ...
            <AbsoluteCenter maxW={"full"} w={"756px"} p={"20px"}>
                <Box textAlign={"center"} color={"white"}>
                    <Text fontSize={"2xl"} display={"block"} lineHeight={"none"} fontWeight={"hairline"}>
                        HELLO I'M
                    </Text>
                    <Box
                        color={"yellow.400"}
                    ...
                    >
                        {textDisplay}<Text className="typingLookLike" fontWeight={"hairline"}>|</Text>
                    </Box>
                    <Text fontSize={maxWidth576 ? "sm" : "md"} fontWeight={"light"} display={"block"} lineHeight={"base"}>
                        Passionate software engineer fueling innovation through code. Embracing programming, technology, and problem-solving to create a brighter future.
                    </Text>
                </Box>
            </AbsoluteCenter>
        </Box>
